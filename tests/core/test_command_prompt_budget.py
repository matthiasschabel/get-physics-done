...
COMMAND_BASELINES = {
    ...
    "numerical-convergence": (570, 26_143, 1),
    "parameter-sweep": (688, 28_500, 1),
    ...
    "route": (185, 7_305, 1),
    "sensitivity-analysis": (568, 24_951, 1),
    "set-profile": (171, 9_451, 1),
    "set-tier-models": (215, 8_449, 1),
    "settings": (415, 28_792, 1),
...
WORKFLOW_BASELINES = {
    ...
    "numerical-convergence": (482, 22_813, 0),
    "parameter-sweep": (607, 26_403, 1),
    ...
    "route": (130, 5_142, 0),
    "sensitivity-analysis": (479, 21_543, 0),
    "set-profile": (134, 7_229, 0),
    "set-tier-models": (167, 6_903, 0),
    "settings": (381, 27_616, 1),
